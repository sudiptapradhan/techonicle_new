      ...
      <div className="row">
        <div className="col-lg-8 feed-bnr">
          <div className="bnr-img">
            <img alt = "Img1" className="img-responsive img-fluid" src="https://media.istockphoto.com/photos/digital-artist-working-at-home-picture-id1213781338?b=1&k=20&m=1213781338&s=170667a&w=0&h=bDVoUJdiVm7eA_Kw1yEcX1mS-PnB0Jh6bS00NNVnu-g="/>
        ...
        <img alt = "Img1" className="img-responsive img-fluid" src="https://media.istockphoto.com/photos/young-couple-kissing-picture-id1357748432?b=1&k=20&m=1357748432&s=170667a&w=0&h=_9Uba8kRvlGe88u1biFF7acFHyUnJrz84-mMb-oU34w="/>
        <div className="bnr-descrptn mt-3">
        ...
        <img alt = "Img1" className="img-responsive img-fluid" src="https://media.istockphoto.com/photos/young-businesswoman-standing-in-the-corridor-picture-id1283362093?b=1&k=20&m=1283362093&s=170667a&w=0&h=TrVSAILp38qGk6HYOmrAJrx4S-CDVHFOP0yJy_Uzihg="/>
        <div className="bnr-descrptn mt-3">
          <div className="date ms-1 me-1">69 Feb</div>
          <div className="time ms-1 me-1">5 min read</div>
